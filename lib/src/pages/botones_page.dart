      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Todas tus necesidades en una sola actividad:',
  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(children: [
          _crearBotonRedondeado(Colors.pinkAccent, Icons.shop, 'Multimedia'),
          _crearBotonRedondeado(
              Colors.orange, Icons.insert_drive_file, 'Fichero'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(
        ...
        TableRow(children: [
          ...
          _crearBotonRedondeado(Colors.teal, Icons.help_outline, 'Preguntas'),
        ])
      ],
    );
  }
